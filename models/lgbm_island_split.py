...
#Print the job
print(f"Running hyperparameter optimization for lgbm with {phenotype} with {num_SNPs} SNPs...")
...
def objective(trial, X_train, y_train):
    params = {
        ...
        "num_leaves": trial.suggest_int("num_leaves", 8, 3000),
...
outer_mae = []
outer_corr = []
output_file = f"lgbm_island_split_{phenotype}.csv"
